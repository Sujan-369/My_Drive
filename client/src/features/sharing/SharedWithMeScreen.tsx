...
import { Folder, FileText, Download, Users } from 'lucide-react';
      ...
      {!isLoading && shares && shares.length > 0 && (
        <div className="overflow-hidden rounded-xl border border-border">
          <div className="divide-y divide-border">
            {shares.map((share) => (
              <div key={share.shareId} className="flex items-center gap-3 px-4 py-3 transition-colors hover:bg-white/3">
